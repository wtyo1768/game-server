const config = {
  ...
  'google': {
    ...
    'callbackURL': (process.env.NODE_ENV.trim() == "development") ?
     'http://localhost:3000/api/user/Auth' : 'https://test.citychaser.com/api/user/Auth',
  },
  ...
  'facebook' : { 
    ...
    'callbackURL': (process.env.NODE_ENV.trim() == "development") ?
    'http://localhost:3000/api/user/facebook/cb' :'https://test.citychaser.com/api/user/facebook/cb',
  },
}
